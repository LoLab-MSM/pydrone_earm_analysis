...
def sims_kd(label):
    ...
    if label == 0:
        ...
        pars_label1[:, 58] = pars_ref1[58] * 0.8  # 20% Knock down of bcl2
        ...
        pars_label2[:, 57] = pars_ref2[57] * 0.8  # 20% Knock down of mcl1
    ...
    if label == 1:
        ...
        pars_label1[:, 56] = pars_ref1[56] * 0.8  # 20% Knock down of bclxl
        sim1 = ScipyOdeSimulator(model, tspan=tspan, param_values=pars_label1).run()
        sim1.save('earm_scipyode_sims_good{0}.h5'.format(label))
        ...
        pars_label2[:, 58] = pars_ref2[58] * 0.8  # 20% Knock down of bcl2
        sim2 = ScipyOdeSimulator(model, tspan=tspan, param_values=pars_label2).run()
        sim2.save('earm_scipyode_sims_bad{0}.h5'.format(label))
    ...
    if label == 2:
        ...
        pars_label1 = pars[np.where(clus_sp37_labels == label)]
        # pars_label1[:, 63] = pars_ref1[63] * 0.8  # 20% Knock down of bax
        pars_label1[:, 57] = pars_ref1[57] * 0.8  # 20% Knock down of mcl1
        sim1 = ScipyOdeSimulator(model, tspan=tspan, param_values=pars_label1).run()
        sim1.save('earm_scipyode_sims_good{0}.h5'.format(label))

        pars_label2 = pars[np.where(clus_sp37_labels == label)]
        # pars_label2[:, 63] = pars_ref2[63] * 0.8  # 20% Knock down of bax
        pars_label2[:, 56] = pars_ref2[56] * 0.8  # 20% Knock down of bclxl
        sim2 = ScipyOdeSimulator(model, tspan=tspan, param_values=pars_label2).run()
        sim2.save('earm_scipyode_sims_bad{0}.h5'.format(label))
    ...
    if label == 6:
        ...
        pars_label2[:, 56] = pars_ref2[56] * 0.8  # 80% Knock down of bclxl
        sim2 = ScipyOdeSimulator(model, tspan=tspan, param_values=pars_label2).run()
        sim2.save('earm_scipyode_sims_bad{0}.h5'.format(label))
